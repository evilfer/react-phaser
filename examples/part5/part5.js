...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameImpl = __webpack_require__(69);
	...
	module.exports = {
	    components: {
	        ...
	        childrenMount: function childrenMount(node, children) {},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setProperties = __webpack_require__(70),
	    addChildActors = function addChildActors(nodes, gameNode, children, groupNode) {
	    children.forEach(function (childId) {
	        ...
	        switch (child.tag) {
	            case 'sprite':
	                {
	                    ...
	                    var _child$props$x = _child$props.x;
	                    var x = _child$props$x === undefined ? 0 : _child$props$x;
	                    var _child$props$y = _child$props.y;
	                    var y = _child$props$y === undefined ? 0 : _child$props$y;
	                    var sprite = _child$props.sprite;
	
	                    child.obj = groupNode ? groupNode.obj.create(x, y, sprite) : gameNode.obj.add.sprite(x, y, sprite);
	            ...
	            case 'group':
	                child.obj = groupNode ? groupNode.obj.create() : gameNode.obj.add.group();
	                setProperties(nodes, gameNode, child, child.props);
	                if (child.children.length > 0) {
	                    addChildActors(nodes, gameNode, child.children, child);
	                }
	    ...
	    create = function create(gameNode, nodes) {
	    var _gameNode$props = gameNode.props;
	    var _gameNode$props$asset = _gameNode$props.assets;
	    var assets = _gameNode$props$asset === undefined ? {} : _gameNode$props$asset;
	    var width = _gameNode$props.width;
	    var height = _gameNode$props.height;
	    var _gameNode$props$mode = _gameNode$props.mode;
	    var mode = _gameNode$props$mode === undefined ? Phaser.AUTO : _gameNode$props$mode;
...
/***/ function(module, exports) {
	...
	var defaultPropValues = {
	    ...
	    setProperties = function setProperties(nodes, gameNode, node, nextProps) {
	    var prevProps = arguments.length <= 4 || arguments[4] === undefined ? null : arguments[4];
	    ...
	    setActorProperties = function setActorProperties(gameNode, node, useProps, nextProps) {
	    ...
	    setCollidesProperties = function setCollidesProperties(nodes, gameNode, node, useProps, nextProps) {
	    if (useProps[0] === 'with') {
	    ...
	    setCursorsProperties = function setCursorsProperties(nodes, gameNode, node, useProps, nextProps) {
	    if (useProps[0] === 'onInput') {
	        var onInput = nextProps.onInput,
	            cursors = gameNode.obj.input.keyboard.createCursorKeys(),
	            getActor = function getActor(name) {
	    ...
	    setAnimationProperties = function setAnimationProperties(nodes, gameNode, node, useProps, nextProps, prevProps) {
	    if (prevProps === null) {
